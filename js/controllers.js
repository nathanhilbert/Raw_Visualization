      ...
      jQuery.each(optSet['charts'], function(chartname,chartopts){
        ...
        $.each($scope.charts, function(i,v){
          if (v.title() == chartopts['chartType']){
            $scope.chartset[chartname] = {'chart': v};
